...
class DataLoadPreprocess(Dataset):
    def __init__(self, args, mode, transform=None, is_for_online_eval=False, img_path='/home/leiguojun/data/image_2/', 
                 depth_path='/home/leiguojun/data/kitti_depth/'):
        self.args = args
        if mode == 'online_eval':
    ...
    def __getitem__(self, idx):
        ...
        depth_gt_path = self.depth_tag[idx]
        frame_num = self.depth_tag[idx].split('/')[-1].split('-')[-1].split('.')[0]
        image_path = self.img_path + frame_num + '.png'
